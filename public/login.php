...
<head>
  ...
  <style>
    /* Page-scoped styling for login UI */
    body.login-page{background:linear-gradient(135deg,#a1c4fd 0%, #c2e9fb 35%, #d4c2fc 100%)}
        ...
        <div class="card-body">
          ...
          <form method="post" autocomplete="on">
            ...
            <div class="flex gap-sm mb-md" style="margin-top:.5rem;align-items:center;justify-content:space-between">
              <a class="muted" href="forgot_password.php">Forgot password?</a>
